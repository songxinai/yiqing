    ...
    public static void refesh() {
        ...
        try {
            ...
            for(Element s:listdiv2) {
                ...
                dao.add("info1", sheng, xinzeng, leiji, zhiyu, siwang,time,kind);//将爬取到的数据添加至数据库，注意需将“myinfo”修改为你的表名
            }
            //爬取海外数据
            ...
            for(Element s:listdiv22) {
                ...
                AddService dao=new AddService();
                dao.add("info", country, xinzeng, leiji, zhiyu, siwang,time,kind);//将爬取到的数据添加至数据库，注意需将“myinfo”修改为你的表名           
            }    
