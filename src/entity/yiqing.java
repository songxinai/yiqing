...
public yiqing(int id, String date, String province, String city, String confirmed_num, String yisi_num, String cured_num,String dead_num,
		 String code) {
	super();
	this.id = id;
	this.date = date;
...
public yiqing(String date,  String province,String city, String confirmed_num, String yisi_num, String cured_num, String dead_num,
		String code) {
	super();
	this.date = date;
	this.city = city;
...
public yiqing(String date, String province, String confirmed_num, String yisi_num, String dead_num, String cured_num) {
	super();
	this.date = date;
	this.province = province;
	this.confirmed_num = confirmed_num;
